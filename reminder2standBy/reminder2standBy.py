...
# Save settings, in same directory as main .py file.

# TODO: complete functions, that controllers is disabled in GUI (settings
# window) (when track sound try not to be reseted by sounds this program
# created)
